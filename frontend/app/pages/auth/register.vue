      ...
      <template #content>
        <form @submit.prevent="handleRegister" class="space-y-6">
          ...
          <div class="flex flex-col gap-2">
            ...
            <Password id="password" v-model="password" toggleMask placeholder="********" class="w-full" inputClass="w-full" />
          </div>

          <div class="flex flex-col gap-2">
            <label for="confirmPassword" class="text-sm font-medium text-gray-700">確認密碼</label>
            <Password id="confirmPassword" v-model="confirmPassword" :feedback="false" toggleMask placeholder="********" class="w-full" inputClass="w-full" />
          </div>
          ...
          <div class="flex flex-col gap-2">
            ...
            <div class="flex flex-col gap-2">
              ...
              <div class="flex items-center">
                <RadioButton v-model="role" inputId="rolePhotographer" name="role" value="photographer" />
